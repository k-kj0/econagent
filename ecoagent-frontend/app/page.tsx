...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const greetAndListen = () => {
      const greeting = 'Hey Boss, what would you like to know today?';
      const utt = new SpeechSynthesisUtterance(greeting);
      utt.rate = 0.95; utt.pitch = 1.0;
      utt.onend = () => startCommandListening();
    ...
    const startCommandListening = () => {
      ...
      commandRecog.onend = () => { setListening(false); setWakeActive(false); };
      commandRecog.start();
    };
